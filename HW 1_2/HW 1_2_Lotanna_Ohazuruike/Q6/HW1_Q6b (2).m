...
bfile=fopen('bifurcations_matlab_6b.txt','w');
pfile=fopen('periods_matlab_6b.txt','w');
...
%% Plotting
data=load('bifurcations_matlab_6b.txt');
%import the data
...
saveas(gcf,'bifurcation 6b','epsc');
