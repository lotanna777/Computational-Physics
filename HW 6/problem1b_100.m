...
%%%%%%%% Compare with three different value of D, for small D, such as 1
%%%%%%%% and 10, density will exponentially increase with time, for large
%%%%%%%% D,such as 100, density will increase very slowly with time.
